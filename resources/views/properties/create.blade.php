        ...
        <div class="card shadow-lg border-0 rounded-4 rb-card">
          ...
          <div class="card-header text-white rounded-top-4 py-3"
            ...
            <h4 class="mb-0 text-center fw-semibold">
              <i class="bi bi-building me-2"></i> Add New Property
            </h4>
          </div>
              ...
              <div id="imageLimitToast" class="toast align-items-center text-white bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="d-flex">
                  <div class="toast-body fw-semibold">
                    You can upload a maximum of 10 images. Please remove some images or select fewer files.
                  </div>
            ...
            <form action="{{ route('properties.store') }}" method="POST" enctype="multipart/form-data" novalidate>
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-4">
                  ...
                  <input
                    ...
                    placeholder="Eg. 1200" value="{{ old('price') }}" required>
                ...
                <div class="col-md-4">
                  ...
                  <div class="row g-2">
                    <div class="col-6">
                      ...
                      <input id="latitude" name="latitude" type="text" class="form-control" value="{{ old('latitude') }}" readonly>
                    </div>
                    <div class="col-6">
                      <label class="form-label small" for="longitude">Longitude</label>
                      <input id="longitude" name="longitude" type="text" class="form-control" value="{{ old('longitude') }}" readonly>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-md-3 col-6 mb-2">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="amenities[]" value="{{ $amenity->id }}"
                             id="amenity{{ $amenity->id }}" {{ in_array($amenity->id, old('amenities', [])) ? 'checked' : '' }}>
              ...
              <div class="mb-4" data-field="images">
                ...
                <div id="dropZone" class="border border-2 border-dashed rounded-3 p-5 text-center bg-light" role="button" tabindex="0" aria-label="Upload images">
                  ...
                  <p class="mt-2 mb-0">Drag & drop property images here, or <span class="text-primary fw-semibold">browse</span></p>
                  <small class="text-muted">JPEG/PNG, up to 10MB each, maximum 10 images</small>
                  <input type="file" id="images" name="images[]" class="d-none" multiple accept="image/*">
                </div>
                <div id="imagePreview" class="row g-3 mt-3"></div>
                {{-- top-level validation for the images array --}}
              ...
              <div class="d-flex gap-2 justify-content-end">
                ...
                <a href="{{ route('dashboard') }}" class="btn btn-outline-secondary px-4 py-2">Cancel</a>
              </div>
            </form>
          </div> {{-- /card-body --}}
        </div> {{-- /card --}}
...
@push('head')
  {{-- Font Awesome for amenity icons (used as "fa {{ $amenity->icon }}") --}}
...
<script>
  ...
  function handleFiles(selectedFiles) {
    ...
    const totalImages = filesArray.length + newFiles.length;
